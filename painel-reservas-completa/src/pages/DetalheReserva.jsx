...
export default function DetalheReserva() {
  ...
  const { reservas, alterarStatus } = useReservas();
  ...
  if (!reserva) {
    return (
      <main>
        ...
        <p>
          O endereço informado não corresponde a uma reserva cadastrada.
        </p>
